...
export default function JobsDashboard() {
  ...
  const stats = [
    ...
    {
      label: 'In Production',
      value: jobStats?.stageBreakdown?.IN_PRODUCTION || 0,
      icon: Wrench,
  ...
  const pipelineStages = [
    { stage: 'LEAD_ASSIGNED', label: 'Lead Assigned', count: jobStats?.stageBreakdown?.LEAD_ASSIGNED || 0 },
    { stage: 'SCHEDULED', label: 'Scheduled', count: jobStats?.stageBreakdown?.SCHEDULED || 0 },
    { stage: 'INSPECTED', label: 'Inspected', count: jobStats?.stageBreakdown?.INSPECTED || 0 },
    { stage: 'CLAIM_FILED', label: 'Claim Filed', count: jobStats?.stageBreakdown?.CLAIM_FILED || 0 },
    { stage: 'APPROVED', label: 'Approved', count: jobStats?.stageBreakdown?.APPROVED || 0 },
    { stage: 'CONTRACT_SIGNED', label: 'Contract Signed', count: jobStats?.stageBreakdown?.CONTRACT_SIGNED || 0 },
    { stage: 'IN_PRODUCTION', label: 'In Production', count: jobStats?.stageBreakdown?.IN_PRODUCTION || 0 },
  ];
