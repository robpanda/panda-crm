    ...
    try {
      ...
      const integrationsList = [
        ...
        },
        {
          ...
          description: 'Calendar sync for appointments and scheduling',
          status: integrationStatus.googleCalendar?.connectedResources > 0 ? 'connected' : 'disconnected',
          ...
          stats: {
            connectedResources: integrationStatus.googleCalendar?.connectedResources || 0,
            lastError: null,
          },
