...
class ChatWebview {
    static panelCount = 0;
    static activePanels = new Set();
    _panel;
    _extensionUri;
    _panelId;
    _disposables = [];
    _messageHandler;
    constructor(panel, extensionUri, panelId) {
        this._panel = panel;
    ...
    static create(extensionUri) {
        ...
        const panel = vscode.window.createWebviewPanel("pandaClaudeChat", title, column || vscode.ViewColumn.Beside, {
            enableScripts: true,
