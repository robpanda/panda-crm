...
app.get('/health', (req, res) => {
  res.json({ status: 'healthy',
    service: 'champions',
    timestamp: new Date().toISOString(), buildSha: process.env.BUILD_SHA || process.env.GITHUB_SHA || 'unknown', buildTime: process.env.BUILD_TIME || process.env.GITHUB_RUN_ID || null });
});
