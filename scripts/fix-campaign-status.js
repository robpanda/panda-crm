 ...
 *
 * Usage:
 *   node fix-campaign-status.js --dry-run           # Preview changes
 *   node fix-campaign-status.js                      # Apply fixes
 *   node fix-campaign-status.js --campaign-id=xxx   # Fix specific campaign
 */
...
async function main() {
  ...
  for (const campaign of stuckCampaigns) {
    ...
    if (!DRY_RUN) {
      ...
      console.log(`   [DRY RUN] Would update campaign status to COMPLETED.`);
    }
